		...
		<tbody>
			<c:forEach items="${empleados}" var="e">
				<tr>
					...
					<td><a class="btn btn-sm btn-primary" href="admin/formulario?id=${e.id}">Editar</a> <a class="btn btn-sm btn-danger" href="admin/borrar?id=${e.id}" onclick="return confirm('¿Estás seguro?')">Borrar</a></td>
				</tr>
			</c:forEach>
		</tbody>
